...
//				var Timer = S.later(promotionControl.getPromoItemWait,5000,true,null);
	        ...
	        getPromoItemWait : function(){
				...
				if(list.length > 0){
					var sucess = function(o){
						...
						for (var i=0; i<len; i++) {
							DOM.html('#J_promoStatus'+items[i].id,items[i].msg);
...
//									S.later(promotionControl.getPromoItemWait,5000,true,null);
								}
								var errorHandle = function(o){
