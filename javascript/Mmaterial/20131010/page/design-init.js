...
KISSY.add('page/mods/designControl',function (S,Overlay,TShop) {
 ...
 * @author  
 */
KISSY.add('page/design-init',function (S,showPages,TShop,ListParam,designControl,Switchable,Select,Overlay,beautifyForm) {   
    // your code here
	var DOM = S.DOM, Event = S.Event;	
